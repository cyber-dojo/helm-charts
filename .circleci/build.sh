...
export CYBEROJO_GCS_HELM_REPO_PUBLIC_URL="https://storage.googleapis.com/$CYBERDOJO_HELM_REPO_BUCKET_NAME"
...
helm repo index .charts --url $CYBEROJO_GCS_HELM_REPO_PUBLIC_URL 
#--merge oldIndex.yaml
